...
class Game:
    def __init__(self):
        ...
        self.restart_text_rect = self.restart_text.get_rect(center=(300, 350))

        # Load sounds
        self.sound_flap = pg.mixer.Sound("assets/sounds/flap.wav")
        self.sound_gameover = pg.mixer.Sound("assets/sounds/gameover.wav")
        self.sound_restart = pg.mixer.Sound("assets/sounds/restart.wav")
    ...
    def checkCollisions(self):
        if len(self.pipes):
            ...
            if self.bird.rect.bottom > 568:
                if self.is_game_started:   # ensures sound plays ONLY once
    ...
    def updateEverything(self, dt):
        if self.is_enter_pressed:
            ...
            # Generate pipes
            if self.pipe_generate_counter > 250:
